    ...
    <script src="{{ asset('/scripts/usuarios/usuarios.js') }}"></script>
    <script src="{{ asset('/scripts/clientes/clientes.js') }}"></script>
    <script src="{{ asset('/scripts/estudiantes/estudiantes.js') }}"></script>
