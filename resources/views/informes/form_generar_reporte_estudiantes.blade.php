...
<div class="container">
  ...
  <div class="reporte-box">
    <h3>Generar Formato de Evaluaciones</h3>
    <div class="form-row col-md-12 mt-2">
      ...
      <div class="col-md-2">
          ...
          <select class="form-control" id="curso1" name="curso1"  required onchange="infoEstudiantes(this.value)">
            <option value="" selected >Seleccione...</option>
      ...
      <div class="col-md-3">
          ...
          <select class="form-control" id="estudiante1" name="estudiante1"  required disabled>
            <option value="" selected >Seleccione...</option>
      ...
      <div class="col-md-2" style="margin-top: 28px;" >
       <button onclick="generarReporteEstudianteEvaluaciones()"><i class="fa fa-download" style=""></i> Generar</button>
      </div>
    </div>
  </div>

  <div class="reporte-box">
    <h3>Generar Certificado de Estudios</h3>
    <div class="form-row col-md-12 mt-2">
      <div class="col-md-2">
          <label for="feLastName">Año Curso</label><spam style="color: red;"> * </spam>
      ...
      <div class="col-md-2">
          <label for="feLastName">Curso</label><spam style="color: red;"> * </spam>
          <select class="form-control" id="curso2" name="curso2"  required onchange="infoEstudiantes2(this.value)">
            <option value="" selected >Seleccione...</option>
              @foreach($grados as $grado)
                <option value="{{$grado->id}}">{{$grado->nombre}}</option>
              @endforeach
      ...
      <div class="col-md-3">
          <label for="feLastName">Estudiante</label><spam style="color: red;"> * </spam>
          <select class="form-control" id="estudiante2" name="estudiante2"  required disabled>
            <option value="" selected >Seleccione...</option>
              @foreach($estudiantes as $estudiante)
                <option value="{{$estudiante->id}}">{{$estudiante->nombre_estudiante}}</option>
              @endforeach
      ...
      <div class="col-md-2" style="margin-top: 28px;" >
       <button onclick="generarReporteCertificadoEstudiosEstudiante()"><i class="fa fa-download" style=""></i> Generar</button>
      </div>
    </div>
  </div>

  <div class="reporte-box">
    <h3>Generar Constancia de Estudios</h3>
    <div class="form-row col-md-12 mt-2">
      <div class="col-md-3">
          <label for="feLastName">Año Curso</label><spam style="color: red;"> * </spam>
          <select class="form-control" id="anio3" name="anio3"  required>
            <option value="" selected >Seleccione...</option>
              @foreach($anios as $anio)
                <option value="{{$anio->id}}">{{$anio->anio_inicio}}-{{$anio->anio_fin}}</option>
              @endforeach
      ...
      <div class="col-md-3">
          <label for="feLastName">Curso</label><spam style="color: red;"> * </spam>
          <select class="form-control" id="curso3" name="curso3"  required onchange="infoEstudiantes3(this.value)">
            <option value="" selected >Seleccione...</option>
              @foreach($grados as $grado)
                <option value="{{$grado->id}}">{{$grado->nombre}}</option>
              @endforeach
      ...
      <div class="col-md-3">
          <label for="feLastName">Estudiante</label><spam style="color: red;"> * </spam>
          <select class="form-control" id="estudiante3" name="estudiante3"  required disabled>
            <option value="" selected >Seleccione...</option>
              @foreach($estudiantes as $estudiante)
                <option value="{{$estudiante->id}}">{{$estudiante->nombre_estudiante}}</option>
              @endforeach
      ...
      <div class="col-md-2" style="margin-top: 28px;" >
       <button onclick="generarReporteConstanciaEstudiosEstudiante()"><i class="fa fa-download" style=""></i> Generar</button>
      </div>
    </div>
  </div>
