      ...
      <table border  class='table table-generic table-strech table-font-normal table-hover' style="margin-bottom: 15px;" >
        ...
        <tbody>
            <tr>
              ...
              <td style="text-align: center; width: 30px;">{{ number_format($materia['nota2'] ?? '',1) }}</td>
              <td style="text-align: center; width: 30px;">{{ number_format($materia['nota3'] ?? '',1) }}</td>
    ...
    <table border  class='table table-generic table-strech table-font-normal table-hover' >
      ...
      <tbody>
          <tr>
            ...
            <td>{{ number_format($boletin['data_comportamiento']['nota3'] ?? '',1) }}</td>
            <td></td>
            <td></td>
