                                        ...
                                        <div class="wow fadeInDown" data-wow-delay="0.3s">
                                            ...
                                            <div class="col-md-6 col-xl-6 mb-5 mx-auto">
                                                       ...
                                                       <div class="align-items-center text-center" data-wow-delay="0.3s" style='background-color: rgba(3, 14, 19, 0.89); padding:20px 20px 20px 20px;'>
                                                          ...
                                                          <div ><i class="fa fa-times-circle-o" style='font-size:5em;font-weight: 100;color: red;' aria-hidden="true"></i></div>
                                                            <div><h5><b>Terminos y Condiciones</b></h5></div>
                                                            <div><p>Falta confirmar que acepta los terminos y condiciones del Portal</p>

                                                                <a href="{{ url('register')}}">VOLVER</a>
                                                            </div>
