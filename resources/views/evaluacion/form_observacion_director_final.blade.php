...
<form  method="post"  action="adicionar_observacion_final_reporte" id="f_adicionar_observacion_final_reporte"   >
   ...
   <table border  class='table table-generic table-strech table-font-normal table-hover' >
    ...
    <div class="form-row col-md-12 mt-2">
      ...
      <div class="col-md-4">
          <label for="feLastName">Docente</label><spam style="color: red;"> * </spam>
    ...
    <div class="form-row col-md-12 mt-2">
     <textarea id="observacion" name="observacion" rows="5" maxlength="1000" style="width: 100%;font-size: 15px;">{{$observacionFinal->obs_final}}</textarea>
    </div>
    <br>
