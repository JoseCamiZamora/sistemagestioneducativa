...
<form  method="post"  action="adicionar_concepto_final" id="f_adicionar_concepto_final"   >
   ...
   <table border  class='table table-generic table-strech table-font-normal table-hover' >
    ...
    <div class="form-row col-md-12 mt-2">
      ...
      <div class="col-md-4">
        <label for="feLastName">Nombre Materia:</label>
        <input  class="form-control " name="nom_estudiante" value="{{$claseDocente->nom_materia}}" required style="margin-top: -6px;" disabled>
      </div>
      <div class="col-md-2">
