        ...
        <div class="col-12 col-md-6 col-lg-3 mb-4" >
          <div class="stats-small card card-small">
            ...
            <div class="d-flex px-3 text-center">
                  <a href="{{ url('/evaluacion/listado_materias_configuradas/'.$usuarioactual->id_persona.'/'.$idAnio.'') }}" style='width: 100%'>
                  <img src="{{ asset('/assets/img/periodo1.svg') }}" style='max-height: 40px;' onerror="this.onerror=null; this.src='image.png'">
                  <h4 style='margin-bottom: 1px;' >{{$perido->nombre }}</h4>
                  <span  class="text-primary" style="font-size:1.0em;margin-top:1px;" >Ver Materias</span>
                  </a>
              </div>
            </div>
          </div>
