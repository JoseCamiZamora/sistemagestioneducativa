            ...
            <tbody>
             ...
             @foreach($lstEstudiantes as $estudiante)
                <tr>
                  ...
                  <a class="nav-link nav-link-icon text-center"  href="javascript:void(0);"  onclick="conceptoFinalComportamiento({{$estudiante->id}},{{$curso->id}})" id="subirfile" >
                      <div class="nav-link-icon__wrapper">
...
<div class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="modal_concepto_final_comp">
  <div class="modal-dialog modal-lg" style="max-width: 70%;">
    <div class="modal-content">
      <div class="modal-header" id="datohtml">
        <h4 class="modal-title" id="titul_modal_usuarios">Concepto Final Evaluación Comportamiento</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body" id="contenido_modal_concepto_final_comp" style='min-height: 260px;'>
      </div>
    </div>
  </div>
</div>
