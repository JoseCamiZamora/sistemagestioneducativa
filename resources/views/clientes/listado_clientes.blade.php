...
<div class="main-content-container container-fluid px-4 pb-4">
	  ...
	  <div class="page-header row no-gutters py-4">
	    <div class="col">
	      <span class="page-subtitle">Modulo Clientes </span>
	        ...
	        <h4 class="page-title" >Listado clientes para venta de productos  <span style='font-size: 0.6em;'></span> </h4>
  ...
  <!-- Default Light Table -->
	  ...
	  <div class="row">
	    <div class="col">
        <a  href="{{ url('clientes/listado_clientes/U') }}" class="mb-2 btn btn-sm btn-primary mr-1 " ><i class="fa fa-users margin-icon" aria-hidden="true" ></i>Clientes para venta</a>
	      <a  href="{{ url('clientes/listado_clientes_c') }}" class="mb-2 btn btn-sm btn-sacundary mr-1 " ><i class="fa fa-users margin-icon" aria-hidden="true" ></i>Clientes para compra</a>
	  ...
	  <form  method="post"  action="{{ url('clientes/buscar_cliente') }}" id="f_buscar_cliente"   >
        <input type="hidden" name="_token" id='_token_avatar' value="<?php echo csrf_token(); ?>">    
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              ...
              @if(isset($busqueda))
              <a href="{{ url('clientes/listado_clientes') }}" class="btn btn-white  btn-azul"   >
	    ...
	    <div class="col">
            ...
            <thead class="bg-light">
              <tr>
                ...
                <th scope="col" class="th-gris text-left" >Tipo Identificación</th>
                <th scope="col" class="th-gris text-left" >Identificación</th>
             ...
             @foreach($clientes as $cliente)
                <tr>
                  ...
                  <td>
                    ...
                    onclick="editarcliente({{$cliente->id}},'{{$cliente->tipo}}')" role="button" id="subirfile" >
