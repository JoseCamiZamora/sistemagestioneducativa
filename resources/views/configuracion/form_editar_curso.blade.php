...
<form  method="post" action="editar_curso" id="f_editar_curso">
  <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> 
  <input type="hidden" id="id_curso" name="id_curso" value="{{$curso->id}}">
  <div class="form-row col-md-12">
    <div class="form-group col-md-8">
      <label for="feLastName">Nombre Curso</label><spam style="color: red;"> * </spam>
      <input type="text" style="text-transform: uppercase;" maxlength="50" class="form-control" id="curso" name="curso"  
    ...
    <div class="col-md-4">
      ...
      <select class="form-control" id="tipo" name="tipo" style="margin-top: -6px; height: 33px;padding-top: 4px;" required>
          <option value="{{$curso->tipo_curso}}">{{$curso->nom_clasificacion}}</option>
    ...
    <div class="col-md-12" style="margin-top: 10px;te">
      <button type="submit" class="btn btn-success" id="btn_actualizar" style="display:block">Actualizar el curso</button>
    </div>
</form>
<script>
