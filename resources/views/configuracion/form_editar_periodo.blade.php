...
<form  method="post" action="editar_periodo" id="f_editar_periodo">
  <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>"> 
  <input type="hidden" id="id_periodo" name="id_periodo" value="{{$periodo->id}}">
  <div class="form-row col-md-12">
    <div class="form-group col-md-12">
      <label for="feLastName">Nombre Periodo</label><spam style="color: red;"> * </spam>
      <input type="text" style="text-transform: uppercase;" maxlength="50" class="form-control" id="periodo" name="periodo"  
      value="{{$periodo->nombre}}" required >
    </div>
  </div>
    <div class="col-md-12" style="margin-top: 10px;te">
      <button type="submit" class="btn btn-success" id="btn_actualizar" style="display:block">Actualizar el Periodo</button>
    </div>
</form>
<script>
