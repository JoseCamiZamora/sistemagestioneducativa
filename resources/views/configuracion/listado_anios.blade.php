...
<div class="container">
  ...
  <!-- Default Light Table -->
	  ...
	  <div class="row">
	    <div class="col">
        <a href="javascript:void(0);" onclick="IN_form_crear_new_anio();" class="mb-2 btn btn-sm btn-outline-primary mr-1" ><i class="fa fa-user-plus margin-icon" aria-hidden="true" ></i>Registrar Nuevo Año</a>
	    </div>
	  </div>
	  <div class="row">
	    <div class="col">
             ...
             @foreach($lstAnios as $anio)
                <tr>
                  ...
                  <td>
                    ...
                    onclick="editarAnio({{$anio->id}})" role="button" id="subirfile" >
