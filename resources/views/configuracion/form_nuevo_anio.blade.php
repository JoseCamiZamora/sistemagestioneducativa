...
<form  method="post" action="adicionar_nuevo_anio" id="f_adicionar_nuevo_anio" >
  ...
  <div class="form-row col-md-12 mt-2">
      ...
      <div class="d-flex flex-wrap gap-2 gap-md-3">
        @foreach($periodos as $periodo)
          <div class="form-check espaciado-checkbox" >
            <input class="form-check-input periodo-checkbox" type="checkbox" value="{{$periodo->id}}" id="periodo{{$periodo->id}}" name="periodos[]">
    ...
    <div class="col-md-10" style="margin-top: 10px;">
      ...
      <div class="d-flex flex-wrap gap-2 gap-md-3">
        @foreach($tiposEvaluacion as $actividad)
          <div class="form-check espaciado-checkbox" >
            <input class="form-check-input actividad-checkbox" type="checkbox" value="{{$actividad->id}}" id="actividad{{$actividad->id}}" name="actividades[]">
    ...
    <div class="col-md-10" style="margin-top: 10px;">
      ...
      <div class="d-flex flex-wrap gap-2 gap-md-3">
        @foreach($grados as $curso)
          <div class="form-check espaciado-checkbox" >
            <input class="form-check-input curso-checkbox" type="checkbox" value="{{$curso->id}}" id="curso{{$curso->id}}" name="cursos[]">
    ...
    <div class="col-md-12" style="margin-top: 10px;">
      <button type="submit" class="btn btn-success" id="btn_actualizar" style="display:block">Agregar el nuevo Año</button>
    </div>
  </div>
</form>
<script>
