...
<form  method="post" action="adicionar_nueva_periodo" id="f_adicionar_nuevo_curso">
  ...
  <div class="form-row col-md-12">
    <div class="form-group col-md-8">
      ...
      <input type="text" style="text-transform: uppercase;" maxlength="100" class="form-control" id="curso" name="curso"  
      value="" required >
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-12" style="margin-top: 10px;te">
      <button type="submit" class="btn btn-success" id="btn_actualizar" style="display:block">Agregar nuevo curso</button>
    </div>
</form>
<script>
