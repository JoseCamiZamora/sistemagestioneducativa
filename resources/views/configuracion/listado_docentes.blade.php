            ...
            <tbody>
             ...
             @foreach($lstDocentes as $docente)
                <tr>
                  ...
                  <td class='td-titulo text-left'>{{ $docente->nombres}} {{ $docente->apellidos}}</td>
                  ...
                  <td>
                   ...
                   <td>
                    <a class="nav-link nav-link-icon text-center"  href="javascript:void(0);" 
                    onclick="confDirectorGrupo({{$docente->id}})" role="button" id="subirfile" >
                      <div class="nav-link-icon__wrapper">
                        <i class="fa fa-edit" title="Configuraciòn para director de grupo" style=""></i><br>
                      </div>
                    </a>
                  </td>
                </tr>
...
<div class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="modal_dir_grupo">
  <div class="modal-dialog modal-lg" style="max-width: 60%;">
    <div class="modal-content">
      <div class="modal-header" id="datohtml">
        <h4 class="modal-title" id="titul_modal_usuarios">Configurar el curso el cual sera director de grupo</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body" id="contenido_modal_dir_grupo" style='min-height: 260px;'>
      </div>
    </div>
  </div>
</div>
