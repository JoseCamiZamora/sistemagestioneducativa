                  ...
                  <td>
                    ...
                    onclick="verInfoEstidiante({{$estudiante->id}})" role="button" id="subirfile" >
                      <div class="nav-link-icon__wrapper">
                        <i class="fa fa-eye" title="Ver Ficha Tecnica Estudiante" style=""></i><br>
                      </div>
                    </a>
                  </td>
                  <td>
                    <a class="nav-link nav-link-icon text-center"  href="javascript:void(0);" 
                    onclick="matricularEstudiante({{$estudiante->id}},'{{$estudiante->estado}}')" role="button" id="subirfile" >
                      <div class="nav-link-icon__wrapper">
                        <i class="fa fa-list" title="Matricular Estudiante" style=""></i><br>
                      </div>
                    </a>
                  </td>
                </tr>
...
<div class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="modal_asociar_estudiantes">
  <div class="modal-dialog modal-lg" style="max-width: 60%;">
    <div class="modal-content">
      ...
      <div class="modal-body" id="contenido_modal_asociar_estudiantes" style='min-height: 260px;'>
      </div>
    </div>
  </div>
</div>
